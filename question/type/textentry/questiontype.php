 ...
 */
class question_textentry_qtype extends default_questiontype {
    var $usablebyrandom;

    function question_textentry_qtype() {
    ...
    function print_question_formulation_and_controls(&$question, &$state, $cmoptions, $options) {
        ...
        // Only use the rich text editor for the first textentry question on a page.
        ...
        if (empty($options->readonly)) {
            ...
            $usehtmleditor = FALSE;
            $answer = print_textarea($usehtmleditor, 3, 80, 630, 20, $inputname, $value, $cmoptions->course, true);
        } else {
        ...
        include("$CFG->dirroot/question/type/textentry/display.html");
    ...
    /**
     * Backup the extra information specific to an textentry question - over and above
    ...
    /**
     * Runs all the code required to set up and save an textentry question for testing purposes.
...
//////////////////////////////////////////////////////////////////////////
question_register_questiontype(new question_textentry_qtype());
?>
