...
<div align="center">
	<a href="" onclick="document.forms['faszfejanko'].action='analysis_cqr_1213_autumn_feedback.php';document.forms['faszfejanko'].submit();return false;">
...
<tr>
	...
	<td align="right">
		<div class="singlebutton">
			<input type="submit" value="Show responses" onclick="document.forms['faszfejanko'].action='show_entry_cqr_1213_autumn_feedback.php?userid=<?php echo $student->id; ?>';document.forms['faszfejanko'].submit();return false;">
		</div>
	</td>
	<?php
	...
	?>
		<td align="right">
			<div class="singlebutton">
				<input type="submit" value="Delete entry" onclick="if(confirm('Are you sure you want to delete this entry?'))document.forms['faszfejanko'].action='show_entries_cqr_1213_autumn_feedback.php?delete=1&completedid=<?php echo $student->completedid; ?>&userid=<?php echo $student->id; ?>';document.forms['faszfejanko'].submit();return false;">
			</div>			
		<?php
		/*
