 ...
 */
/* nkowald - 2010-06-09 - Need to add where clause to answer count */
function feedback_get_completeds_group_count($feedback, $groupid = false, $courseid = false, $and_clause = false) {
    global $CFG;
