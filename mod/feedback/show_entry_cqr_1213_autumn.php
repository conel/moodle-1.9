...
<div class="continuebutton">
	<div class="singlebutton">
		<input type="submit" value="Continue" onclick="document.forms['faszfejanko'].action='show_entries_cqr_1213_autumn.php';document.forms['faszfejanko'].submit();return false;">
	</div>
</div>
