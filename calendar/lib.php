...
function calendar_top_controls($type, $data) {
    ...
    switch($type) {
        case 'frontpage':
			...
			// nkowald - 2011-04-13 - Add anchor tag for calendar so it can jump to same position on page load
			$content .= '<a href="" name="cal"></a>';
...
function calendar_get_link_href($linkbase, $d, $m, $y) {
	...
	// nkowald - 2011-04-13 - Added anchortag to url so it jumps back to calendar position
	$endlink = $linkbase . $paramstr;
    return $endlink;
}
