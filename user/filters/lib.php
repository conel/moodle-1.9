...
class user_filtering {
    ...
    function user_filtering($fieldnames=null, $baseurl=null, $extraparams=null) {
        ...
        if (empty($fieldnames)) {
			// nkowald - 2011-01-05 - added ID number field to user search as that's the one I use the most.
            $fieldnames = array('realname'=>0, 'lastname'=>1, 'firstname'=>1, 'email'=>1, 'idnumber'=>0, 'city'=>1, 'country'=>1,
    ...
    function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
			...
			// nkowald - 2011-01-05 - added ID number field to user search as that's the one I use the most.
            case 'idnumber':    return new user_filter_text('idnumber', 'ID number', $advanced, 'idnumber');
