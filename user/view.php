...
///     /course/user.php
    ...
    if (!isset($hiddenfields['mycourses'])) {
		// nkowald - 2010-11-11 - Instead of getting all courses a user has access to, only show courses they're enrolled on
		...
		if ($mycourses = get_my_courses($user->id)) {
            ...
            foreach ($mycourses as $mycourse) {
				...
				// Find if user is an E-learning technologist
				// nkowald - 2011-09-13 - E-learning techs especially have a massive list so let's trim this down to 25
				$staff_or_student = get_role_staff_or_student($user->id);
				if ($staff_or_student == 3) {
					if($shown==25) {
						$courselisting.= "...";
						break;
					}
