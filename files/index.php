    ...
    function html_header($course, $wdir, $formfield=""){
        ...
        if ($choose) {
            ...
            <?php
				...
				// nkowald - 2010-11-18 - Adding email attachments to messages
				if ($choose == 'message_attachment') {
					?>
					<script type="text/javascript">
					//<![CDATA[
					function set_value(txt) {
						opener.document.getElementById('<?php echo $chooseparts[0] ?>').value = txt;
						opener.document.getElementById('file_name').innerHTML = txt + ' <a href=\"messageselect.php?id=<?php echo $course->id; ?>&amp;del=attachment\" id=\"del_attach\">Remove</a>';
						window.close();
					}
					//]]>
					</script>
