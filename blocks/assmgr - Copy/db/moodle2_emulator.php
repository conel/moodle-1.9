...
if (!$PAGE || !($PAGE->type == 'course-view')) {
	...
	// nkowald - 2010-10-29 - This was interfering with our my-moodle page types
	if ($PAGE->type != 'my-student' && $PAGE->type != 'my-staff') {
...
/* nkowald - 2011-02-18 - Had to comment this out as it breaks our custom My Moodle setup
