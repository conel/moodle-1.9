...
if($access_isassessor && !$access_isverifier) {
    ...
    $navlinks[] = array('name' => $course->shortname, 'link' => $CFG->wwwroot."/blocks/assmgr/actions/list_portfolio_assessments.php?course_id={$course->id}", 'type' => 'title');
...
$PAGE->set_url('/VLE/blocks/assmgr/actions/edit_portfolio.php', $PARSER->get_params());
