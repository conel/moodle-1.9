<?php
/**
 * Displays a table of Good Performance Records, filtered by optional parameters
...
$heading = implode(' - ', $heading).' : Good Performance Records';
...
require_once("{$CFG->dirroot}/blocks/lpr/views/good_performance_records.html");
