...
$navlinks[] = array(
    'name' => get_string('learnersoutstandingreviews','block_lpr'),
    'link' => null
);
...
$heading = implode(' - ', $heading).' : '.get_string('learnersoutstandingreviews', 'block_lpr');
...
$outstanding = $lpr_db->get_learners_outstanding_rev($category_id, $course_id, $table, $start_timestamp, $end_timestamp);
...
require_once("{$CFG->dirroot}/blocks/lpr/views/outstanding_reviews.html");
