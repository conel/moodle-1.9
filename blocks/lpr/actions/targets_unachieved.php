<?php
/**
 * Displays a table of Targets Achieved, filtered by optional parameters
...
$heading = implode(' - ', $heading).' : Unachieved Targets';
...
$ilps = $lpr_db->get_unachieved_targets($category_id, $course_id, $table, $start_timestamp, $end_timestamp);
...
require_once("{$CFG->dirroot}/blocks/lpr/views/targets_unachieved.html");
