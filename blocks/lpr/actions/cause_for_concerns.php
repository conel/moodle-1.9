<?php
/**
 * Displays a table of Cause for Concerns, filtered by optional parameters
...
$heading = implode(' - ', $heading).' : Cause for Concerns';
...
require_once("{$CFG->dirroot}/blocks/lpr/views/cause_for_concerns.html");
