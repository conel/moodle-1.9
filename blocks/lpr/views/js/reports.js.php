<script type="text/javascript">
    ...
    function toggle_category_menu(id) {
        if(document.getElementById('cat'+id).style.display == 'block') {
            ...
            document.getElementById('img'+id).src = '<?php echo $CFG->wwwroot; ?>/theme/standard/pix/t/icon-toggle-open.png';
        } else {
            document.getElementById('cat'+id).style.display = 'block';
            document.getElementById('img'+id).src = '<?php echo $CFG->wwwroot; ?>/theme/standard/pix/t/icon-toggle-close.png';
        }
    }
            ...
            while(elem.id != 'category_browser') {
                if(elem.nodeName == 'UL') {
                    ...
                    if(img && img.alt != 'empty_nav') {
                        img.src = '<?php echo $CFG->wwwroot; ?>/theme/standard/pix/t/icon-toggle-close.png';
                    }
                }
