...
/// Print headers
    ...
    if ($course->id != SITEID) {
        print_header(fullname($user)." ".get_string('ilp_student_info','block_ilp_student_info'), $course->fullname,"<a href=\"../../course/view.php?id=$course->id\">$course->shortname</a> -> "."<a href=\"../../blocks/ilp/view.php?courseid=$course->id&amp;id=$user->id\">".get_string("ilp", "block_ilp")."</a> -> ".get_string('ilp_student_info','block_ilp_student_info')." -> ".fullname($user)."", "", "", true, "&nbsp;", navmenu($course));
    } else {
        print_header(fullname($user)." ".get_string('ilp_student_info','block_ilp_student_info'), $course->fullname,"<a href=\"../../blocks/ilp/view.php?courseid=$course->id&amp;id=$user->id\">".get_string("ilp", "block_ilp")."</a> -> ".get_string('ilp_student_info','block_ilp_student_info')." -> ".fullname($user)."", "", "", true, "", navmenu($course));
    }
