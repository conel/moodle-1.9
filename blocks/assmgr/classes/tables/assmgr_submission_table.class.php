            ...
            <form id="<?php echo $this->uniqueid; ?>_filters" method="post" action="<?php echo $this->baseurl.$this->fragment; ?>">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
							// nkowald - 2011-11-7 - Swapped 'uncomfirmed' with 'incomplete and hid 'uncomfirmed' - commented out bits is what it was before
                            if($this->get_filter('show_outcomes')) { ?>
                                <select name="<?php echo $this->uniqueid; ?>[filters][show_outcomes_set]" id="<?php echo $this->uniqueid; ?>show_outcomes_set">
                                    ...
                                    <option value="<?php echo OUTCOMES_SHOW_UNATTEMPTED; ?>" <?php if($this->get_filter('show_outcomes_set') == OUTCOMES_SHOW_UNATTEMPTED) { echo 'selected="selected"'; } ?>><?php echo get_string('incomplete', 'block_assmgr'); ?></option>
                                </select>
                                <?php
                            } ?>
                        </td>
