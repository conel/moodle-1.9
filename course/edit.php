...
/// first create the form
    ...
    if ($editform->is_cancelled()){
		...
		// nkowald - 2010-09-28 - Performing a trim before it updates the data because editors were leaving spaces in idnumber fields and such.
        ...
        if (empty($course)) {
			...
			// nkowald - 2011-11-10 - If course contains an idnumber we want to add a new record to the mdl_course_idnumber_archive
			update_course_id_archive($course);
            ...
            if (!update_course($data)) {
				...
				// nkowald - 2010-11-08 - Need to update table 'mdl_course_idnumber_archive', specifically the current year's idnumber
				update_course_id_archive($data);
			}
            redirect($CFG->wwwroot."/course/view.php?id=$course->id");
        }
    }
