<?php  // $Id: mod.php,v 1.9.2.2 2008/12/03 16:31:01 samulik Exp $
	...
	// nkowald - 2011-09-09 - Adding a new capability to teachers and managers can access course import features
    if (has_capability('moodle/course:create', $syscontext) || has_capability('moodle/course:bulkmessaging', $syscontext) ) {
        $creator = true;
    }
