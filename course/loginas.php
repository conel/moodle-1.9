...
/// Create the new USER object with all details and reload needed capabilitites
    ...
    print_header_simple($strloggedinas, '', build_navigation(array(array('name'=>$strloggedinas, 'link'=>'','type'=>'misc'))),'', '', true, '&nbsp;', navmenu($course));
    
	// nkowald - 2010-06-28 - When we log in as another user we need to check if they're staff or student and redirect them to 'my moodle' accordingly.
	$my_moodle_url = ($CFG->wwwroot.'/my/');
    //notice($strloggedinas, "$CFG->wwwroot/course/view.php?id=$course->id");
    notice($strloggedinas, $my_moodle_url);
