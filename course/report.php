<?php // $Id: report.php,v 1.6.2.2 2008/11/29 14:30:56 skodak Exp $
	...
	foreach ($directories as $directory) {
        // nkowald - 2010-08-18 - Adding link to new statistics
        if ($directory == 'stats') {
            $link = $CFG->wwwroot ."/stats/index.php?filter=all&amp;course_id=".$id."&amp;stat_type=all&amp;view=course";
            echo '<div class="plugin">';
            echo '<p><a href="'.$link.'">Course Statistics</a></p>';
            echo '</div>';
        } else {
