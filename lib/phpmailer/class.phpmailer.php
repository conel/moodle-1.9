...
class PHPMailer
{
    ...
    */
    ...
    function Send() {
		...
		// nkowald - 2011-09-29 - Hate that I have to hack here
		// If email address contains @conel.ac.uk or @staff.conel.ac.uk change host to ADMIN-EXCH.conel.ac.uk
		...
		} else if (strstr($this->to[0][0], '@conel.ac.uk') !== FALSE) {
			// Staff
			$this->Host = 'ADMIN-EXCH.conel.ac.uk';
		}
