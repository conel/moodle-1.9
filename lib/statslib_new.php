...
function stats_get_parameters($time,$report,$courseid,$mode,$roleid=0) {
    ...
    case 'uploads':
    case 'deletes':
        $param->fields = sql_concat('time_end','role_id').' AS uniqueid, time_end, role_id, stat1 as line1';
        ...
        if ($courseid == SITEID) {
            $param->fields = sql_concat('time_end','role_id').' AS uniqueid, time_end, role_id, sum(stat1) as line1';
    ...
    case STATS_REPORT_ACTIVITY:
        $param->fields = sql_concat('time_end','role_id').' AS uniqueid, time_end, role_id, activity as line1';
        $param->fieldscomplete = true; // set this to true to avoid anything adding stuff to the list and breaking complex queries.
        $param->aggregategroupby = 'role_id';
        $param->stattype = 'activity';
        $param->crosstab = true;
