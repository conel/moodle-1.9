...
// nkowald - 2011-02-9 - Changed default CSV delimiter
$csv_delim = ';';
...
// nkowald - 2009-09-24 - Added the following two headers as Internet Explorer used to not be able to save these
...
echo format_csv($header, $csv_delim, '"');
...
foreach($outcomes as $outcome) {
    ...
    echo format_csv($line, $csv_delim, '"');
}
...
function format_csv($fields = array(), $delimiter = ';', $enclosure = '"') {
    ...
    foreach ($fields as $value) {
		// nkowald - removing \r\n from values as it was breaking the imports
