<?php // $Id: file.php,v 1.46.2.5 2009/04/09 09:30:32 skodak Exp $
    ...
    if (count($args) >= 3 and strtolower($args[1]) === 'moddata' && $args[2] != 'jpgs_data') {
	...
	// nkowald - 2009-09-23 - Changing default cache lifetime to 1 minute so when user overrides existing file it will show newest
	$lifetime = '0';
