...
/// Run all cron jobs for each module
    ...
    */
	...
	mtrace("Starting nightly statistics updating");
	/* nkowald - 2010-10-04 
    * Update main statistics for this month so far, then main directorate, school and curriculum area stats - stats for all types, all, views, adds etc. */

    $stats = new StatsEnhanced();
    $stats->updateStatsFromCron();
